-- Squashed migration: add_domain_entity_models + improve_domain_models
-- Combines both migrations into one clean final state.
...
-- CreateIndex
CREATE UNIQUE INDEX "veridian_credential_credentialSaid_key" ON "veridian_credential"("credentialSaid");

-- CreateIndex
CREATE INDEX "veridian_credential_schemaSaid_idx" ON "veridian_credential"("schemaSaid");

-- CreateIndex
CREATE INDEX "veridian_credential_issueeAid_idx" ON "veridian_credential"("issueeAid");
