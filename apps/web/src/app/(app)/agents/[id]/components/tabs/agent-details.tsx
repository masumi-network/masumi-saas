    ...
    <div className="mx-auto w-full max-w-3xl space-y-8">
      {showVerificationCta &&
        ...
        !isVerificationBannerDismissed && (
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-4 rounded-md border border-amber-500/20 bg-amber-500/5 px-4 py-3 pr-10">
