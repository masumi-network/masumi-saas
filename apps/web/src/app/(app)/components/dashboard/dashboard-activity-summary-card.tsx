...
export function DashboardActivitySummaryCard({
  ...
  return (
    <Link href="/activity" className="block h-full" aria-label={ariaLabel}>
      <Card className="dashboard-stat-card group h-full rounded-xl border border-border/80 transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-md">
        ...
        <CardContent className="flex flex-1 flex-col">
          ...
          <p className="mt-2 flex items-center gap-0.5 text-xs font-medium text-primary group-hover:underline">
