...
describe("/registry/api/v1/registry-entry-search", () => {
  ...
  it("forwards fuzzy registry search requests without charging credits", async () => {
    ...
    const request = new NextRequest(
      "https://saas.example.com/registry/api/v1/registry-entry-search?network=Preprod",
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ query: "example capability", limit: 5 }),
      },
    );
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      "https://registry.example.com/api/v1/registry-entry-search/?network=Preprod",
      expect.objectContaining({
        method: "POST",
        body: JSON.stringify({ query: "example capability", limit: 5 }),
      }),
