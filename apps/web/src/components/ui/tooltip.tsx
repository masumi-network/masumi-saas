    ...
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          ...
          "z-50 max-w-[min(22rem,calc(100vw_-_2rem))] origin-(--radix-tooltip-content-transform-origin) rounded-lg border-0 px-3.5 py-2 text-sm leading-snug tracking-normal text-balance shadow-md",
      ...
      >
        ...
        <TooltipPrimitive.Arrow
          className={cn(
            "z-[51] size-3 fill-tooltip translate-y-[calc(-50%_-_1px)]",
            arrowClassName,
          )}
        />
      </TooltipPrimitive.Content>
