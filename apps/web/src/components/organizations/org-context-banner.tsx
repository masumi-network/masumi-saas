...
export function OrgContextBanner({
  orgHrefSuffix = "dashboard",
}: {
  orgHrefSuffix?: string;
}) {
  ...
  const orgHref = `/organizations/${activeOrganization.slug}?from=${orgHrefSuffix}`;

  return (
    <div className="flex w-fit items-center gap-3 rounded-lg border border-border/60 bg-muted-surface px-4 py-2.5">
...
/** @deprecated Use OrgContextBanner */
export const DashboardOrgContextBanner = OrgContextBanner;
